...
var ListItem = _styledComponents["default"].li.withConfig({
  ...
  componentId: "uq8dkl-1"
})(["display:inline-block;margin-right:10px;border-radius:100%;box-sizing:border-box;position:relative;height:38px;width:38px;border-color:", ";&:hover > *{width:", ";height:", ";cursor:pointer;}", ""], function (props) {
